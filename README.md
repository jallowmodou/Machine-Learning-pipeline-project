...
This is the code for a Hands-on project on how to build and implement a Machine learning pipeline using python web frame-work as back-end. It featured many boilerplates codes, framework and pre-built materials to achieved the project. 
